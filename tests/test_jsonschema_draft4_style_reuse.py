...
def test_allof_str():
    assert str(
        Example.a) == "<AllOf [<Number. Properties: maximum = 20, minimum = -10, multiplesOf = 5>, <Integer>, <Positive>]>"
...
def test_anyoff_str():
    assert str(
        Example.b) == "<AnyOf [<Number. Properties: maximum = 20, minimum = -10>, <Integer>, <Positive>, <String>]>"


def test_oneof_str():
    assert str(
        Example.c) == "<OneOf [<Number. Properties: maximum = 20, minimum = -10, multiplesOf = 5>, <Integer>, <Positive>, <String>]>"
