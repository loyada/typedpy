...
def test_str_Structure():
    assert str(
        Person) == "<Structure: Person. Properties: foo = <Structure. Properties: a = <String>, b = <Structure. Properties: c = <Number. Properties: " \
...
def test_str_Structure_instance():
    ...
    assert str(
        p) == "<Instance of Person. Properties: foo = <Instance of Structure. Properties: a = 'aaa', b = <Instance of Structure. Properties: c = 10, d " \
